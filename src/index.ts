    ...
    onload() {
        this.addTab({
          ...
          init() {
            ...
            <div id="shadow" style="height: 100%; width: 100%; position: absolute; z-index: 1;">
            ...
            // wheel
            const defaultViewManager = rendition.requireManager('default');
            defaultViewManager.container.addEventListener('wheel', onwheel);
            // go 
